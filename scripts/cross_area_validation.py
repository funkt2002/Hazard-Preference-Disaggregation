...
DEMO_DATA_DIR = BASE_PATH / "data" / "demo_data"
VALIDATION_OUTPUT_DIR = BASE_PATH / "extras" / "validation_results" / "cross_area"
...
class CrossAreaValidator:
    ...
    def load_data(self) -> bool:
        ...
        parcels_path = DEMO_DATA_DIR / "dataset/fire_risk_local_quantile_wui_parcels/fire_risk_local_quantile_wui_parcels.shp"
        ...
        for area_key, area_info in AREAS.items():
            area_path = DEMO_DATA_DIR / area_info['path']
