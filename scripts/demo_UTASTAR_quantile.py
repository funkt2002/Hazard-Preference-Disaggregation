...
OUTPUTS_DIR = BASE_PATH / "extras" / "outputs" / "demo_utastar_quantile"
OUTPUTS_DIR.mkdir(parents=True, exist_ok=True)
SHAPEFILE_OUTPUT_DIR = DEMO_DATA_DIR / "outputs_quantile"
...
SELECTION_PATHS = [
    ...
    'selections/san_roque_to_misssion_canyon/san_roque_reduced_200.shp',
